...
{
    public partial class ch5 : System.Web.UI.Page
    {
        ...
        {
            StreamWriter s = new StreamWriter(System.AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/test/ch5.txt");
            ...
            s.Close();
            Response.Redirect("~/chapter2/predict.aspx");
        }
