...
{
    public partial class ch4 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            StreamWriter s = new StreamWriter(System.AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/test/ch4.txt");
            ...
            s.Close();
            Response.Redirect("~/chapter2/ch5.aspx");
        }
    }
}