...
{
    public partial class ch3 : System.Web.UI.Page
    {
        ...
        {
            StreamWriter s = new StreamWriter(System.AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "/test/ch3.txt");
            ...
            s.Close();
            Response.Redirect("~/chapter2/ch4.aspx");
        }
